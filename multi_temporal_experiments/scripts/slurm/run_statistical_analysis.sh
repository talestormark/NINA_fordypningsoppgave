...
echo "--- Per-sample statistical analysis ---"
python multi_temporal_experiments/scripts/modeling/statistical_analysis_persample.py \
    --num-folds 5 \
...
python multi_temporal_experiments/scripts/modeling/boundary_f_score_analysis.py \
    --tolerance 2 \
    --threshold 0.5 \
    --num-folds 5 \
    --n-permutations 10000 \
