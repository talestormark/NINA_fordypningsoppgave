...
# ============================================================================
# LSTM-2: Bi-temporal (T=2) — unified 400-epoch protocol
# ============================================================================
#
...
#
# Usage:
#   for fold in 0 1 2 3 4; do sbatch retrain_exp003_bitemporal.sh $fold; done
# ============================================================================

FOLD=${1:-"0"}

echo "=========================================="
echo "LSTM-2: Bi-temporal (T=2) — 400 epochs, no ES"
echo "=========================================="
echo "Fold: $FOLD / 4"
echo "Batch size: 8"
...
OUTPUT_DIR="PART1_multi_temporal_experiments/outputs/experiments/exp003_v3_fold${FOLD}"
