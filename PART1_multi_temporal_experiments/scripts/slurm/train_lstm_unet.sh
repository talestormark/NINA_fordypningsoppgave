...
mkdir -p PART1_multi_temporal_experiments/outputs/logs
mkdir -p PART1_multi_temporal_experiments/outputs/experiments
...
OUTPUT_DIR="PART1_multi_temporal_experiments/outputs/experiments/${EXP_ID}"
