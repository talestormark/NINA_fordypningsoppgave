...
from experiments/annotation_efficiency/outputs/<exp>/fold{0-4}/best_model.pth,
...
def main():
    ...
    parser.add_argument(
        ...
        help='Experiment output dir name(s) under experiments/annotation_efficiency/outputs/'
    )
    parser.add_argument(
