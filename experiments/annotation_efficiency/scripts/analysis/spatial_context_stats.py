...
Output: experiments/annotation_efficiency/outputs/statistical_tests/spatial_context_stats.json
"""
...
PART2_DIR = REPO / "PART2_spectral_spatial_resolution_experiments"
