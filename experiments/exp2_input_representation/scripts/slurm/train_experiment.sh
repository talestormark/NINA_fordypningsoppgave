...
OUTPUT_DIR="experiments/exp2_input_representation/outputs/experiments/${OUTPUT_NAME}_fold${FOLD}"
echo "Output directory: $OUTPUT_DIR"
echo ""

# Run training
python experiments/exp2_input_representation/scripts/modeling/train.py \
