...
\def\DiffColor{rgb:purple,5;black,3}
...
% Image 2024 (actual VHR RGB) - BOTTOM BRANCH
\node[canvas is zy plane at x=0] (img2024) at (-3,-6,0)
    {\includegraphics[width=6cm,height=6cm]{MScTemplate/figs/input_images/a-0-77133618972711_46-45684360844514_2024.jpg}};
\node[above=0.8cm of img2024, font=\normalsize] {Image 2024 (RGB)};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Siamese Encoder Branch 2 (processes t2 - 2024) - BOTTOM BRANCH
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Difference Operation (Feature-level temporal difference)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Position difference node centered between the two branches
\path (cr5_t1-east) -- (cr5_t2-east) coordinate[pos=0.5] (cr5_mid);
\pic[shift={(2.5,0,0)}] at (cr5_mid)
  {Ball={name=diff, fill=\DiffColor, opacity=0.5, radius=5,
         logo={\scalebox{0.4}{$\scriptstyle |f_{t_2}-f_{t_1}|$}}}};

% Connections from both branches to difference node
\draw [connection]  (cr5_t1-east) -- node {\midarrow} (diff-west);
\draw [connection]  (cr5_t2-east) -- node {\midarrow} (diff-west);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Decoder (U-Net upsampling path with skip connections from difference features)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Upsample 1: H/32 -> H/16
\pic[shift={(2.5,0,0)}] at (diff-east) {Box={name=up4,%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\draw [connection]  (diff-east)      -- node {\midarrow} (up4-west);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Skip Connections (difference features from encoder to decoder)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calculate difference points between branches
...
%% Annotations
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \node[font=\Large, align=center, text=orange] at (-4,5) {Siamese ResNet-50 Encoder};
\node[font=\small, align=center, text=violet] at (-2,0) {(Weight Sharing)};

% \node[font=\normalsize, align=center, text=purple] at (6,-4) {Feature\\Difference};
